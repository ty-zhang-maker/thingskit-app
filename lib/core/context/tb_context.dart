      ...
      if (tbClient.isAuthenticated() && !tbClient.isPreVerificationToken()) {
        ...
        if (tbClient.getAuthUser()!.userId != null) {
          try {
            ...
            versionInfo = mobileInfo?.versionInfo ?? versionInfo;
            storeInfo = mobileInfo?.storeInfo;

            if (_defaultDashboardId() != null) {
              final hasAccess = await checkDasboardAccess(_defaultDashboardId()!);
              if (!hasAccess) {
